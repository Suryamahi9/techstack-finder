...
export default function SignupPage() {
  ...
  async function handleSignup(e) {
    ...
    try {
      ...
      if (signInRes?.error) { setError(signInRes.error); setLoading(false); return; }
      ...
      <main className="relative z-10 mx-auto max-w-md px-4 pb-24 pt-28 sm:px-6">
        <div className="rounded-2xl border border-border bg-elevated p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-elevated px-3 text-faint">or sign up with email</span></div>
          </div>
