      ...
      <div className="rounded-2xl border border-border bg-elevated p-6 animate-fade-up">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-tag-green-fg">No tech debt detected — clean stack!</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="rounded-2xl border border-border bg-elevated p-6 animate-fade-up">
      ...
      <div className="flex gap-2 mb-4">
        {summary.critical > 0 && <span className="inline-flex items-center gap-1 rounded-full bg-tag-red-bg px-2.5 py-0.5 text-[11px] font-semibold text-tag-red-fg">{summary.critical} Critical</span>}
        {summary.high > 0 && <span className="inline-flex items-center gap-1 rounded-full bg-tag-red-bg px-2.5 py-0.5 text-[11px] font-semibold text-tag-red-fg">{summary.high} High</span>}
        {summary.medium > 0 && <span className="inline-flex items-center gap-1 rounded-full bg-tag-yellow-bg px-2.5 py-0.5 text-[11px] font-semibold text-tag-yellow-fg">{summary.medium} Medium</span>}
        {summary.low > 0 && <span className="inline-flex items-center gap-1 rounded-full bg-tag-blue-bg px-2.5 py-0.5 text-[11px] font-semibold text-tag-blue-fg">{summary.low} Low</span>}
      </div>
