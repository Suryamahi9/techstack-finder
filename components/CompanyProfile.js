  ...
  return (
    <section className="animate-fade-up overflow-hidden rounded-2xl border border-border bg-elevated p-5 sm:p-6">
      <div className="mb-4 flex items-center gap-2">
        ...
        <span className="font-mono text-xs uppercase tracking-wider text-faint">Company Profile</span>
      </div>
        ...
        {company.logo && (
          <div className="shrink-0">
            ...
            <img
              ...
              className="h-14 w-14 rounded-xl border border-border bg-bg object-contain p-1.5"
        ...
        <div className="min-w-0 flex-1">
          ...
          {(company.email || company.phone || company.address) && (
            <div className="mt-3 flex flex-wrap gap-x-5 gap-y-1.5 text-xs">
              {company.email && (
                <a href={`mailto:${company.email}`} className="flex items-center gap-1.5 text-muted hover:text-accent">
                  <svg className="h-3 w-3 text-faint" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7">
      ...
      {company.socialLinks?.length > 0 && (
        <div className="mt-5 flex flex-wrap items-center gap-3 border-t border-border pt-4">
          <span className="text-[10px] uppercase tracking-widest text-faint">Find them on</span>
          {company.twitter && (
