export default function Footer() {
  return (
    <footer className="mt-24 border-t border-border bg-bg/55">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div className="flex items-center gap-2 text-sm text-muted">
            <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-[4px] border border-border-strong">
              <svg viewBox="0 0 24 24" className="h-3 w-3 text-fg" fill="none" stroke="currentColor" strokeWidth="2">
