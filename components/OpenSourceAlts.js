          ...
          <div key={i} className="rounded-xl border border-border bg-bg/50 p-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-emerald-400 font-medium">{alt.alt}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[9px] text-faint">{alt.license}</span>
                {alt.savings && <span className="text-[9px] font-semibold text-emerald-400">Save {alt.savings}</span>}
              </div>
            </div>
          </div>
        ))}
