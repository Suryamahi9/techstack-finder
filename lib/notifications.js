...
export async function checkAndNotifyStackChange(monitorId, userId, oldTechs, newTechs) {
  ...
  const html = `
    <div style="font-family:system-ui,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
      <h2 style="color:#c5fb45;">Stack Change Detected</h2>
      ...
      <p style="margin-top:16px;">
        <a href="https://techstack-finder.vercel.app/results?site=${encodeURIComponent(domain)}"
           style="background:#c5fb45;color:#000;padding:10px 20px;border-radius:8px;text-decoration:none;font-weight:600;">
          View Full Report
        </a>
      </p>
