...
export async function fetchServerHistory(domain) {
  try {
...
export async function saveServerHistory(entry) {
  try {
...
export async function getServerHistoryForDomain(domain) {
  return fetchServerHistory(domain);
}
